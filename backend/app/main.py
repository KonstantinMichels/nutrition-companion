...
from app.modules.pantry_consumption_reconciliation.router import (
    router as pantry_consumption_reconciliation_router,
)
...
app.include_router(pantry_consumption_reconciliation_router)
